...
export const Navbar = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 w-full z-50 bg-black/70 backdrop-blur-lg shadow-lg">
      <div className="px-6 lg:px-36 flex items-center justify-between h-20">
  ...
  md:rounded-full backdrop-blur bg-black/90 md:bg-white/10 md:border
