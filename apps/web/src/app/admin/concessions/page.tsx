...
export default function ConcessionsPage() {
  ...
  const stats = {
    ...
    food: concessions.filter((c: Concession) => c.category === 'FOOD').length,
    drink: concessions.filter((c: Concession) => c.category === 'DRINK').length,
    combo: concessions.filter((c: Concession) => c.category === 'COMBO').length,
    merchandise: concessions.filter((c: Concession) => c.category === 'MERCHANDISE').length,
